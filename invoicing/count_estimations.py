...
def calc_estimations():
    ...
    success(" - estimables i endarrerides .............. {:.2f} %",(len(estimable_delayed_ids) * 100.0) / len(estimable_ids))
    success(" - estimables i no endarrerides ........... {:.2f} %",(len(estimable_not_delayed_ids) * 100.0) / len(estimable_ids))
    success("")
