...
#-*- coding: utf8 -*-
"""
Mchimp mailing csv to ask members and owners to
invest in generation depending on their use.
"""
...
with open(sys.argv[1], 'w', encoding='utf8') as f:
    ...
    with db.cursor() as cursor :
        ...
        output(u'\t'.join(unicode(x) for x in [
            'ID',
            'Name',
            'Call name',
            'Soci',
    ...
    #                continue
                ...
                output('\t'.join(
                    ...
                    (line.nsoci and line.nsoci[1:].lstrip('0')) or '-',
                    line.nif[2:],
                    line.email,
                    line.lang,
                    ...
                    line.ncontractes,
                    number_es(totalUse),
                    number_es(recommendedShares),
                    number_es(recommendedShares * shareUse),
                    number_es(recommendedInvestment),
